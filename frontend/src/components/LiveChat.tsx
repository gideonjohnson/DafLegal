    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-24 right-6 z-40 btn-gold w-16 h-16 rounded-full shadow-2xl hover:scale-110 transition-all duration-300 flex items-center justify-center group"
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className={`fixed bottom-24 right-6 z-40 w-96 transition-all duration-300 ${
