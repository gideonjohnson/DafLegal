...
export default function DashboardPage() {
  ...
  const stats = [
    { label: 'Total Features', value: '12', icon: 'M13 10V3L4 14h7v7l9-11h-7z', color: 'text-blue-600' },
    { label: 'Categories', value: '7', icon: 'M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z', color: 'text-purple-600' },
    { label: 'AI-Powered', value: '100%', icon: 'M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z', color: 'text-amber-600' },
    { label: 'Ready to Use', value: 'Now', icon: 'M5 13l4 4L19 7', color: 'text-green-600' },
  ]
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="mb-12 text-center">
            <h1 className="text-5xl font-bold text-[#1a2e1a] dark:text-[#f5edd8] mb-4">
              DafLegal Features Dashboard
            </h1>
            <p className="text-xl text-[#8b7355] dark:text-[#d4c5b0] max-w-3xl mx-auto">
              Your complete AI-powered legal workspace with 12 integrated features
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-12">
            {stats.map((stat, idx) => (
              <div key={idx} className="card-beige p-6 text-center">
                <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-gradient-to-br from-[#d4a561]/20 to-[#b8965a]/20 flex items-center justify-center">
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-lg font-medium transition-all ${
                    activeCategory === category.id
                      ...
                      : 'bg-[#f5edd8]/50 dark:bg-[#1a2e1a]/50 text-[#1a2e1a] dark:text-[#f5edd8] hover:bg-[#d4a561]/20'
                  }`}
                >
                  {category.label}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredFeatures.map((feature) => (
              <Link
                key={feature.id}
                href={feature.href}
                className="group card-beige p-6 hover:shadow-2xl transition-all duration-300 hover:scale-105 border-2 border-transparent hover:border-[#d4a561]"
              >
                {/* Icon & Badge */}
          ...
          {/* CTA Section */}
          <div className="mt-16 card-beige p-12 text-center bg-gradient-to-br from-[#2d5a2d] to-[#1a2e1a]">
            <h2 className="text-3xl font-bold text-[#f5edd8] mb-4">
              Ready to Transform Your Legal Workflow?
            </h2>
            <p className="text-[#d4c5b0] mb-8 max-w-2xl mx-auto">
              Start using our AI-powered features today. No credit card required for trial.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="/analyze" className="btn-gold px-8 py-4 text-lg font-bold">
                Start Analyzing →
              </Link>
              <Link href="/pricing" className="px-8 py-4 bg-white/10 text-[#f5edd8] rounded-lg font-bold hover:bg-white/20 transition-all">
                View Pricing
              </Link>
            </div>
          </div>
