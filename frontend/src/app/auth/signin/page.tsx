    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#f5edd8] to-white dark:from-[#1a2e1a] dark:to-[#2d5a2d]">
      <div className="max-w-md w-full space-y-6">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label htmlFor="password" className="block text-sm font-medium text-[#1a2e1a] dark:text-[#f5edd8]">
                  Password
                </label>
                <Link href="/auth/forgot-password" className="text-xs text-[#d4a561] hover:text-[#b8965a] underline">
                  Forgot?
                </Link>
              </div>
              <input
        ...
        <p className="text-center text-sm text-[#5c4a3d] dark:text-[#d4c5b0]">
          ...
          <Link href="/auth/signup" className="font-semibold text-[#d4a561] hover:text-[#b8965a] underline">
            Create account
          </Link>
        </p>
      </div>
